...
const News = (props) => {
  ...
  useEffect(() => {
    document.title = `${capitalizeFirstLetter(props.category)} - NewsCollector`;
    updateNews();
  ...
  return (
    <>
      <h1 className="text-center" style={{ margin: "20px 0px", marginTop: '83px'}}>
        NewsCollector - Top {capitalizeFirstLetter(props.category)} Headlines
      </h1>
      {loading && <Spinner />}
